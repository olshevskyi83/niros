---
title: Psychological Model Engine
project: NeuroIcaro Research Platform
status: draft
tags: [neuroicaro]
---

# Psychological Model Engine

## Purpose

Psychological Model Engine is one module in the NeuroIcaro platform. Its purpose is to transform a defined input into a safe, inspectable, research-ready output.
