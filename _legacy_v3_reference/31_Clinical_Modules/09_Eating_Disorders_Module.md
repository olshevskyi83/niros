...
version: v2.0
status: future
tags: [clinical-module, eating_disorders, niros]
---
...
Define the NIROS research and personalization structure for `eating_disorders` in psychedelic-session-support contexts.
...
body shame, control, trauma, identity, food fear

## Scenario style

non-triggering, no weight language, compassion-focused
...
```text
modules/clinical/eating_disorders.json
```
