...
version: v2.0
status: future
tags: [clinical-module, addiction, niros]
---
...
Define the NIROS research and personalization structure for `addiction` in psychedelic-session-support contexts.
...
craving, shame, relapse cycles, identity, motivation

## Scenario style

non-judgmental, direct, agency-focused
...
```text
modules/clinical/addiction.json
```
