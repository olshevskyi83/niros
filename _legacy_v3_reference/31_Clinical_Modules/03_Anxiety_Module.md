...
version: v2.0
status: active-mvp
tags: [clinical-module, anxiety, niros]
---
...
Define the NIROS research and personalization structure for `anxiety` in psychedelic-session-support contexts.
...
control, fear, panic, uncertainty, somatic tension

## Scenario style

slow, predictable, grounding, low ambiguity
