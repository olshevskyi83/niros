...
version: v2.0
status: future
tags: [clinical-module, end_of_life_distress, niros]
---

# End-of-Life Distress Module

## Purpose

Define the NIROS research and personalization structure for `end_of_life_distress` in psychedelic-session-support contexts.
...
mortality fear, meaning, unfinished business, grief, love

## Scenario style

existential, soft, worldview-matched
...
```text
modules/clinical/end_of_life_distress.json
```
