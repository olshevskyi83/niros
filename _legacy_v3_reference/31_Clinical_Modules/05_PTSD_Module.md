...
version: v2.0
status: future
tags: [clinical-module, ptsd, niros]
---
...
Define the NIROS research and personalization structure for `ptsd` in psychedelic-session-support contexts.
...
trauma memory, dissociation, hypervigilance, control, safety

## Scenario style

trauma-informed, consent-based, no forcing, strong grounding
