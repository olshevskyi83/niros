...
version: v2.0
status: future
tags: [clinical-module, cluster_headaches, niros]
---

# Cluster Headaches Module

## Purpose

Define the NIROS research and personalization structure for `cluster_headaches` in psychedelic-session-support contexts.
...
attack cycles, fear of recurrence, function, quality of life

## Scenario style

data-oriented, symptom-tracking, less psychological overreach
...
```text
modules/clinical/cluster_headaches.json
```
