---
title: Therapeutic Target Selector
project: NeuroIcaro Research Platform
status: draft
tags: [neuroicaro]
---

# Therapeutic Target Selector

## Purpose

Therapeutic Target Selector is one module in the NeuroIcaro platform. Its purpose is to transform a defined input into a safe, inspectable, research-ready output.
