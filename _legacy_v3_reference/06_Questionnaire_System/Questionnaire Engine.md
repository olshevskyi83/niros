...
Questionnaire Engine is one module in the NeuroIcaro platform. Its purpose is to transform a defined input into a safe, inspectable, research-ready output.
